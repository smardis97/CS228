...
class PYGAME_WINDOW:
    ...
    def draw_help_image(self, hand_present=False, (lr, ud)=(None, None)):
        if hand_present:
            if lr > 0:
                image = pygame.image.load("{}{}".format(constants.IMAGES_PATH, "direct-left.jpg"))
                self.disp_counter = 10
            elif lr < 0:
                image = pygame.image.load("{}{}".format(constants.IMAGES_PATH, "direct-right.jpg"))
                self.disp_counter = 10
            else:
                if ud > 0:
                    image = pygame.image.load("{}{}".format(constants.IMAGES_PATH, "direct-down.jpg"))
                    self.disp_counter = 10
                elif ud < 0:
                    image = pygame.image.load("{}{}".format(constants.IMAGES_PATH, "direct-up.jpg"))
                    self.disp_counter = 10
                elif self.disp_counter > 0:
                    image = pygame.image.load("{}{}".format(constants.IMAGES_PATH, "success.jpg"))
                    self.disp_counter -= 1
                else:
                    return True

        else:
            image = pygame.image.load("{}{}".format(constants.IMAGES_PATH, "place-in-view.jpg"))
            self.disp_counter = 10
        ...
        if number > 9 or number < 0:
            ...
            if level >= 15:
                ...
                if number <= 2:
                    draw_image = False
            if draw_image:
                file_name = "{}{}".format(constants.IMAGES_PATH, "asl-" + str(number) + ".png")
    ...
    def draw_help_visualization(self, warmer):
        if warmer:
            image = pygame.image.load("{}{}".format(constants.IMAGES_PATH, "checkmark.jpg"))
            self.screen.blit(image, (3 * constants.PYGAME_WINDOW_WIDTH / 8, constants.PYGAME_WINDOW_DEPTH / 2))
        else:
            image = pygame.image.load("{}{}".format(constants.IMAGES_PATH, "x.jpg"))
